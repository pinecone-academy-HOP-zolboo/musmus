...
export const HomePage = () => {
    return (
      <div className="home">
        ...
        <div className='posts'>
        {
            data.map((data)=> <MiniPost  id={data._id} userRole={data.userRole} img={data.img} title={data.title} description={data.description} profileImg={data.profileImg} profileName={data.profileName} postDate={data.postDate} postText={data.postText}/>)
        }
        </div>
